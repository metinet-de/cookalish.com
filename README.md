# A statically generated blog example using Cookalish and Markdown

This example showcases Cookalish's [Static Generation](https://nextjs.org/docs/basic-features/pages) feature using Markdown files as the data source.
